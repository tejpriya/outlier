...
(function () {
  ...
  const barChartEl = document.querySelector('#barChart'),
    barChartConfig = {
      ...
      // colors: [chartColors.column.series1, chartColors.column.series2, chartColors.column.series3, chartColors.column.series4, chartColors.column.series5, chartColors.column.series6, chartColors.column.series7, chartColors.column.series8, chartColors.column.series9, chartColors.column.series10],
      // stroke: {
      //   show: true,
      //   colors: ['transparent']
      // },
  ...
  var json_data={"Vehicles": ["Two Wheeler", "Three wheeler/Auto", "Car/Jeep/taxi", "Bus (Mini)", "Bus (Full)", "Van", "LCV", "2 Axle", "3 Axle", "Multi Axle", "With Trailer", "Without Trailer", "Cycle", "Others", "Animal Drawn", "Hand Cart"], "ADT": ["6218", "31", "2436", "7", "84", "27", "734", "745", "252", "388", "11", "0", "0", "0", "0", "0"]};
  barChart.updateOptions({
    xaxis: {
     categories: json_data['Vehicles']
    },
    series: [{
      data: json_data['ADT']
   }],
  ...
  const lineChartEl = document.querySelector('#lineChart'),
    lineChartConfig = {
      ...
      series: [
        {
          data: [280, 200, 220, 180, 270, 250, 70, 90, 200, 15, 160, 100, 150, 100, 450,10]
        }
      ],
      markers: {
        strokeWidth: 7,
        strokeOpacity: 1,
        strokeColors: [config.colors.black],
  ...
  const horizontalBarChartEl = document.querySelector('#horizontalBarChart'),
    horizontalBarChartConfig = {
      ...
      series: [
        {
          data: [300, 350, 480, 600, 210, 550, 150]
        }
      ],
      xaxis: {
  ...
  const radialBarChartEl = document.querySelector('#radialBarChart'),
    radialBarChartConfig = {
      ...
      colors: [chartColors.donut.series1, chartColors.donut.series2, chartColors.donut.series4, chartColors.donut.series5, chartColors.donut.series7, chartColors.donut.series6, chartColors.donut.series3,  chartColors.donut.series2,
      ...
      series: [31.95, 18.52, 0.42, 0.03, 15.73, 6.66, 3.29, 0.01, 0.01],
      labels: ['Car/Van/Jeep', 'Two Wheeler', 'Auto Three Wheeler', 'Two Axle Vehicle', 'MAV', 'Mini Truck <3t', 'Bus', 'Agriculture Tractor', 'Agriculture Tractor Tralier']
    };
  ...
  const donutChartEl = document.querySelector('#donutChart'),
    donutChartConfig = {
      ...
      labels: ['Car/Van/Jeep', 'Two Wheeler', 'Auto Three Wheeler', 'Two Axle Vehicle', 'MAV', 'Mini Truck <3t', 'Bus', 'Agriculture Tractor', 'Agriculture Tractor Tralier'],
      series: [15.77, 4.57, 0.21, 0.02, 34.95, 4.93, 4.87, 0.01, 0.02],
      colors: [
